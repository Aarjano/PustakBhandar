...
namespace FinalProject // Use your project's root namespace or a suitable common namespace
{
    public class ApplicationDbContextFactory : IDesignTimeDbContextFactory<ApplicationDbContext>
    {
        ...
        public ApplicationDbContext CreateDbContext(string[] args)
        {
            ...
            // Create DbContextOptions using the PostgreSQL provider and connection string
            var optionsBuilder = new DbContextOptionsBuilder<ApplicationDbContext>();

            // Configure the DbContext to use PostgreSQL with the specified connection string
